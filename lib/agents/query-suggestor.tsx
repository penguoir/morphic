...
export async function querySuggestor(
  ...
  await experimental_streamObject({
    ...
    system: `As a professional academic researcher, your task is to generate a set of three queries that explore the subject matter more deeply, building upon the initial query and the information uncovered in its search results.
