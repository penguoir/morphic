...
export async function taskManager(messages: ExperimentalMessage[]) {
  ...
  const result = await experimental_generateObject({
    ...
    To achieve this, you must first analyze the user's input and determine the optimal course of action. 
    If it is the first time you are interacting with the user you must output:
    0. "limit" otherwise
